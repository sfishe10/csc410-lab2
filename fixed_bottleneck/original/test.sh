...
httperf --server 54.69.236.149 --port 80 --wsesslog 700,0,input.txt --period e0.05 --dead=35 --rfile=/home/ubuntu/engg_533/responsetimes/rfile.txt > /home/ubuntu/engg_533/responsetimes/output.txt
